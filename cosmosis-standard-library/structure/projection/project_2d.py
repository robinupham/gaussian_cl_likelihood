...
then in the [project_2d] section of your CosmoSIS pipeline ini file, add the line "linspaced = T".

See the original project_2d documentation at https://bitbucket.org/joezuntz/cosmosis/wiki/default_modules/project_2d_1.0
"""
...
class SpectrumCalculator(object):
    ...
    def __init__(self, options):
        ...
        # We use log-spaced output unless lin-spaced is requested
        ...
        linspaced = options.get_bool(option_section, "linspaced", False)
        if linspaced:
            self.ell = np.linspace(ell_min, ell_max, n_ell)
        else:
